...
void CGamestage2::OnInit()
{
    ...
    {
        int arr[] = {1, 2, 3};
        random_born_monster(monster, {"Resources/monster/m1.bmp", "Resources/monster/m2.bmp", "Resources/monster/m3.bmp", "Resources/monster/m4.bmp", "Resources/monster/m5.bmp", "Resources/monster/m6.bmp", "Resources/monster/m7.bmp", "Resources/monster/m8.bmp", "Resources/monster/m9.bmp", "Resources/monster/m10.bmp", "Resources/monster/e1.bmp", "Resources/monster/e2.bmp", "Resources/monster/e3.bmp", "Resources/monster/e4.bmp", "Resources/monster/e5.bmp", "Resources/monster/e6.bmp", "Resources/monster/e7.bmp", "Resources/monster/e8.bmp", "Resources/monster/e9.bmp", "Resources/monster/e10.bmp", "Resources/monster/d1.bmp", "Resources/monster/d2.bmp", "Resources/monster/d3.bmp", "Resources/monster/d4.bmp", "Resources/monster/d5.bmp", "Resources/monster/d6.bmp", "Resources/monster/d7.bmp", "Resources/monster/d8.bmp", "Resources/monster/d9.bmp", "Resources/monster/d10.bmp"},
                            monster_vanish, {"Resources/monster/m11.bmp", "Resources/monster/m12.bmp", "Resources/monster/m13.bmp", "Resources/monster/m14.bmp", "Resources/monster/m15.bmp", "Resources/monster/m16.bmp", "Resources/monster/m17.bmp"}, {255, 255, 255}, {200, 191, 231}); // 255
    ...
    for (int i = 0; i < 6; i++)
    {
        random_born_big_monster(big_monster, {"Resources/monster/big_m0.bmp", "Resources/monster/big_m1.bmp", "Resources/monster/big_m2.bmp", "Resources/monster/big_m3.bmp", "Resources/monster/big_m4.bmp", "Resources/monster/big_m5.bmp", "Resources/monster/big_m6.bmp", "Resources/monster/big_m7.bmp"},
                                big_monster_vanish, {"Resources/monster/big_e0.bmp", "Resources/monster/big_e1.bmp", "Resources/monster/big_e2.bmp", "Resources/monster/big_e3.bmp", "Resources/monster/big_e4.bmp", "Resources/monster/big_e5.bmp", "Resources/monster/big_e6.bmp", "Resources/monster/big_e7.bmp", "Resources/monster/big_e8.bmp", "Resources/monster/big_e9.bmp", "Resources/monster/m17.bmp"}, {255, 255, 255}, {255, 255, 255}); // 255
    ...
    for (int i = 0; i < 6; i++)
    {
        random_born_big_monster(fast_monster, {"Resources/fast_monster/b1.bmp", "Resources/fast_monster/b2.bmp", "Resources/fast_monster/b3.bmp", "Resources/fast_monster/b4.bmp", "Resources/fast_monster/b5.bmp", "Resources/fast_monster/b6.bmp", "Resources/fast_monster/c1.bmp", "Resources/fast_monster/c2.bmp", "Resources/fast_monster/c3.bmp", "Resources/fast_monster/c4.bmp", "Resources/fast_monster/c5.bmp", "Resources/fast_monster/c6.bmp"},
                                fast_monster_vanish, {"Resources/fast_monster/k1.bmp", "Resources/fast_monster/k2.bmp", "Resources/fast_monster/k3.bmp", "Resources/fast_monster/k4.bmp", "Resources/fast_monster/k5.bmp", "Resources/fast_monster/k6.bmp", "Resources/fast_monster/k7.bmp", "Resources/fast_monster/k8.bmp", "Resources/fast_monster/k9.bmp", "Resources/fast_monster/k10.bmp", "Resources/fast_monster/k11.bmp", "Resources/fast_monster/k12.bmp", "Resources/fast_monster/k13.bmp", "Resources/fast_monster/k14.bmp", "Resources/monster/m17.bmp"}, {255, 255, 255}, {255, 255, 255}); // 255
...
void CGamestage2::background_move()
{
    ...
    else if (background.GetLeft() + background.GetWidth() < 1045)
    { // item->character
        if (ax > 0)
        { // turn left
            background.SetTopLeft(background.GetLeft() + ax, background.GetTop() + ay);
    ...
    else if (background.GetTop() + background.GetHeight() < 1045)
    { // character->item
        if ((opera.GetTop()) < 682)
        {
            background.SetTopLeft(background.GetLeft() + ax, background.GetTop() + ay);
...
void CGamestage2::item_move(CMovingBitmap &item)
{
    ...
    if (background.GetLeft() >= character.GetLeft())
    { // character->item
        if (opera.GetLeft() > 437)
        { // turn right
    ...
    else if (background.GetLeft() + background.GetWidth() <= character.GetLeft() + character.GetWidth())
    { // item->character
        if ((opera.GetLeft()) < 437)
        { // turn left
            item.SetTopLeft(item.GetLeft() - int((opera.GetLeft() - 437) * rate), item.GetTop() - int((opera.GetTop() - 682) * rate));
    ...
    else if (background.GetTop() >= character.GetTop())
    { // character->item
        if (opera.GetTop() > 682)
        { // turn right
            item.SetTopLeft(item.GetLeft() - int((opera.GetLeft() - 437) * rate), item.GetTop() - int((opera.GetTop() - 682) * rate));
    ...
    else if (background.GetTop() + background.GetHeight() <= character.GetTop() + character.GetHeight())
    { // item->character
        if ((opera.GetLeft()) > 682)
        { // turn left
            item.SetTopLeft(item.GetLeft() - int((opera.GetLeft() - 437) * rate), item.GetTop() - int((opera.GetTop() - 682) * rate));
        }
        else
...
void CGamestage2::mygame_dart_born()
{
    ...
    dart[i].LoadBitmapByString({"Resources/weapon/hot_wheels/00.bmp",
